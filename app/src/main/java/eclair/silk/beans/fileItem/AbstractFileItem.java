package eclair.silk.beans.fileItem;
...
import eclair.silk.enums.FileType;
import eclair.silk.file.openers.FileOpener;
import eclair.silk.shared.FileTypesFile;
...
public abstract class AbstractFileItem implements Serializable {
    ...
    public Drawable getIcon() {
        ...
        switch (getType()) {
            case APK:
                PackageInfo packageInfo = Utils.getPackageInfo(SILKApplication.getContext(), getAbsolutePath());
                if (packageInfo != null) {
                    try {
                        ApplicationInfo appInfo = packageInfo.applicationInfo;
                        appInfo.sourceDir = getAbsolutePath();
                        appInfo.publicSourceDir = getAbsolutePath();
                        Drawable iconFromApk = appInfo.loadIcon(SILKApplication.getContext().getPackageManager());
